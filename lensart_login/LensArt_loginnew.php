...
<html lang="en" class=""><head>
    ...
    <title>LensArt : Login</title>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/icon" href="C:/xampp/htdocs/lensart_login/assets/images1/icon1.png">
    <!-- Font Awesome -->
			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33" style="border: 1px solid; padding-top: 10px;">
				<form class="login100-form validate-form flex-sb flex-w" method="POST">
					...
					<div class="container-login100-form-btn m-t-17">
						<button class="login100-form-btn" name="sin">
							Sign In
						</button>
					</div>
					...
					<div class="w-full text-center p-t-55">
						...
						<a href="http://localhost/lensart_signup/LensArt_signup.php" class="txt2 bo1">
							Sign up now
						</a>
					</div>
				</form>
...
if($row=mysqli_fetch_assoc($log1))
	{		
		...
		header("Location: http://localhost/lensart/lensart_home/indexlogin.php"); 
		ob_end_flush();
