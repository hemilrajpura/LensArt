...
session_start();
ob_start();			
if(isset($_POST["2ndbday"]))
{
	header("location:http://localhost/edmin/code/2nd-inner-admin-bday.php");
}
if(isset($_POST["3rdbday"]))
{
	header("location:http://localhost/edmin/code/3rd-inner-admin-bday.php");
}
if(isset($_POST["1stbday"]))
{
	header("location:http://localhost/edmin/code/1st-inner-admin-bday.php");
}
...
while($row=mysqli_fetch_assoc($log2))
	...
	if(isset($_POST['imgupd']))
	{
		$image= addcslashes(file_get_contents($_FILES['upd']['tmp_name']));
			 ...
			 $qp1="update birthday SET pname='$image' where id=1";
	...
	if(isset($_POST['imgin']))
	{
		 $image= addslashes(file_get_contents($_FILES[$_POST['upd1']]['tmp_name']));
			$qp="insert into 'birthday' (pname) values('$image') where id=1";
...
$a=$_FILES["up2"]["name"];
$ins="update photos SET bday=('$a') where id=3";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up1"]["name"];
$ins="update photos SET bday=('$a') where id=2";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up3"]["name"];
$ins="update photos SET bday=('$a') where id=4";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up4"]["name"];
$ins="update photos SET bday=('$a') where id=5";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up5"]["name"];
$ins="update photos SET bday=('$a') where id=6";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up7"]["name"];
$ins="update photos SET bday=('$a') where id=7";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up8"]["name"];
$ins="update photos SET bday=('$a') where id=8";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up9"]["name"];
$ins="update photos SET bday=('$a') where id=9";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up10"]["name"];
$ins="update photos SET bday=('$a') where id=10";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up11"]["name"];
$ins="update photos SET bday=('$a') where id=11";
...
/*if(($_FILES["up11"]["size"] / 1024)>2000)
	{
		...
		//header("location:admin-birthday.php");
	} */
if(mysqli_query($c,$ins))
{
...
$a=$_FILES["up12"]["name"];
$ins="update photos SET bday=('$a') where id=12";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
<form method="POST"  enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="title-area">
              <h2 class="tittle">Birthday Sample Images</h2>
  ...
  <div class="">
	...
	$res=("select (bday)from photos where id=1");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
	?>
	<img width='100px'  src="upload/<?php echo $row['bday']; ?> "/>
	<?php
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=2");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=3");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
  ...
  <div class="">
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=4");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
	?>
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=5");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=6");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
  ...
  <div class="">
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=7");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
	?>
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=8");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=9");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
  ...
  <div class="">
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=10");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
	?>
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=11");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
	...
	mysqli_select_db($c,"Lensart");	
		...
		echo "<td>";
	//if(isset($_POST['imgdis'])){	
	$res=("select (bday)from photos where id=12");
	$res1=mysqli_query($c,$res);
	while($row = mysqli_fetch_array($res1))	
	{
                ...
                <ul class="price-table">
                  <li class="wow slideInUp">
                    <div class="single-price">
					  ...
					  <p><?php echo $eight2; ?></p>
				 <button data-text="UPDATE" class="button button-default" name="2ndbday" type="submit">
                  ...
                  <li class="wow slideInUp">
                    <div class="single-price">
                      ...
                      <p><?php echo $five1; ?></p>
                      <p><?php echo $six1; ?></p>
                      <p><?php echo $seaven1; ?></p> <p><?php echo $eight1; ?></p>
                    <button data-text="UPDATE" class="button button-default" name="1stbday" type="submit">
                  ...
                  <li class="wow slideInUp">
                    <div class="single-price">
                      ...
                      <p><?php echo $five3; ?></p>
                      <p><?php echo $six3; ?></p>
                      <p><?php echo $seaven3; ?></p>    <p><?php echo $eight3; ?></p>
                      <button data-text="UPDATE" class="button button-default" name="3rdbday" type="submit">
