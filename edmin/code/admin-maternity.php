...
if(isset($_POST["3rdmat"]))
{
	header("location:http://localhost/edmin/code/3rd-inner-admin-maternity.php");
}
if(isset($_POST["1stmat"]))
{
	header("location:http://localhost/edmin/code/1st-inner-admin-maternity.php");
}
...
while($row=mysqli_fetch_assoc($log1))
	{		
		$one3=$row['Baby Shower'];	
	}
$qry="select * from maternity
 where id=2";
$log2=mysqli_query($c,$qry);
while($row=mysqli_fetch_assoc($log2))
	{		
		 $two3=$row['Baby Shower'];	
	}	
...
while($row=mysqli_fetch_assoc($log2))
	{		
		 $four3=$row['Baby Shower'];	
	}	
$qry="select * from maternity where id=5";
$log2=mysqli_query($c,$qry);
while($row=mysqli_fetch_assoc($log2))
	{		
		 $five3=$row['Baby Shower'];
...
while($row=mysqli_fetch_assoc($log2))
	...
	if(isset($_POST['imgupd']))
	{
		$image= addcslashes(file_get_contents($_FILES['upd']['tmp_name']));
			 ...
			 $qp1="update maternity SET pname='$image' where id=1";
	...
	if(isset($_POST['imgin']))
	{
		 $image= addslashes(file_get_contents($_FILES[$_POST['upd1']]['tmp_name']));
			$qp="insert into 'maternity' (pname) values('$image') where id=1";
...
$a=$_FILES["up"]["name"];
$ins="update photos SET maternity=('$a') where id=1";
...
$a=$_FILES["up2"]["name"];
$ins="update photos SET maternity=('$a') where id=3";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up1"]["name"];
$ins="update photos SET maternity=('$a') where id=2";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up3"]["name"];
$ins="update photos SET maternity=('$a') where id=4";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up4"]["name"];
$ins="update photos SET maternity=('$a') where id=5";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up5"]["name"];
$ins="update photos SET maternity=('$a') where id=6";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up7"]["name"];
$ins="update photos SET maternity=('$a') where id=7";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up8"]["name"];
$ins="update photos SET maternity=('$a') where id=8";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up9"]["name"];
$ins="update photos SET maternity=('$a') where id=9";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up10"]["name"];
$ins="update photos SET maternity=('$a') where id=10";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
$a=$_FILES["up11"]["name"];
$ins="update photos SET maternity=('$a') where id=11";
...
/*if(($_FILES["up11"]["size"] / 1024)>2000)
	{
		...
		//header("location:admin-maternity.php");
	} */
if(mysqli_query($c,$ins))
{
...
$a=$_FILES["up12"]["name"];
$ins="update photos SET maternity=('$a') where id=12";
if(mysqli_query($c,$ins))
{
	echo "<br><script>alert ('File is uploaded successfully'); </script><br>";
/* echo "<br><br><b>File is uploaded successfully</b> "; */
...
<form method="POST"  enctype="multipart/form-data">
  ...
  <div class="">
	...
	{
	?>
	<img width='100px'  src="upload/<?php echo $row['maternity']; ?> "/>
	<?php
            ...
            <div class="pricing-table-content" style="margin-left:116px";>
                <ul class="price-table">
                  ...
                  <li class="wow slideInUp">
                    ...
                    <button data-text="UPDATE" class="button button-default" name="1stmat" type="submit">
                  ...
                  <li class="wow slideInUp">
                    <div class="single-price">
                      ...
                      <button data-text="UPDATE" class="button button-default" name="3rdmat" type="submit">
