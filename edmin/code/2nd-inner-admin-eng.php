...
<p><input type="text" name="eight2" value="<?php  echo $eight2;  ?>" placeholder="<?php  echo $eight2;  ?>" style="height: 30px;
border-radius: 5px;">  </p>
<p><input type="text" name="nine2" value="<?php  echo $nine2;  ?>" placeholder="<?php  echo $nine2;  ?>" style="height: 30px;
border-radius: 5px;">  </p>
