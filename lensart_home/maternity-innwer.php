...
if(isset($_SESSION['uname']))
				{
						//header("location:http://localhost/edmin/code/2nd-innner-engagement.php");
				}
...
<html lang="en">
      ...
      <div class="container" style="width:1218px;">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav main-nav menu-scroll">
            <li><a href="#about">engagement shoots</a></li> 
            <li><a href="#team">Pre-engagement shoots</a></li>                    
            <li><a href="#service">Meternity shoots</a></li> 
            <li><a href="#portfolio">Birthday shoots</a></li>
            <li><a href="#pricing-table">Model shoots</a></li>             
            <li><a href="#from-blog">Engegement Shoots</a></li>      
          </ul>                            
        </div><!--/.nav-collapse -->
 ...
 <a class="fancybox"  data-fancybox-group="gallery" title="Photography">
	...
	{
	?>
	<img class="picture" height="400px" width='350px' style="float:left;" src="../../edmin/code/upload/<?php echo $row['engagement']; ?> "/>
	<?php	
	}	
	}
		?>
	...
	?>
	<img class="picture" width='350px' height="400px"  style="float:left;"  src="../../edmin/code/upload/<?php echo $row['engagement']; ?> "/>
	<?php	
	}	
	}
		?>
...
<a>
  ...
  <div class="footer-bottom" style="background:black">
      <p>Designed by <a rel="nofollow" href="http://www.markups.io/">LensArt Studio</a></p>
    </div>
