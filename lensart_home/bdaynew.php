...
while($row=mysqli_fetch_assoc($log2))
	...
	}	$qry="select * from birthday where id=9";
$log2=mysqli_query($c,$qry);
...
while($row=mysqli_fetch_assoc($log2))
	...
	if(isset($_POST["2ndbd"]))
{
	echo $_SESSION['PackagePrice']=$one2;
	echo $_SESSION['PackageType']="Birthday - second level";
	header("location:http://localhost/lensart_signup/eventform.php");

}
if(isset($_POST["3rdbd"]))
{
	$_SESSION['PackagePrice']=$one3;
	$_SESSION['PackageType']=" Birthday - third level";
	header("location:http://localhost/lensart_signup/eventform.php");
}
if(isset($_POST["1stbd"]))
{
	$_SESSION['PackagePrice']=$one1;
	$_SESSION['PackageType']="Birthday - first level";
	header("location:http://localhost/lensart_signup/eventform.php");
}
}
mysqli_close($c);
...
<html lang="en">
  ...
  <a href="http://localhost/lensart_home/inner-bday.php">
	<table> <tr> <td>
	<div class="album">
	...
	{
	?>
	<img width='180px' height='200' src="../../edmin/code/upload/<?php echo $row['bday']; ?> "/>
	<?php
	...
	{
	?>
	<img width='90px' height='100' src="../../edmin/code/upload/<?php echo $row['bday']; ?> "/>
	<?php
	...
	{
	?>
	<img rowspan=2 colspan=2 width='90px' height='100' src="../../edmin/code/upload/<?php echo $row['bday']; ?> "/>
	<?php
                ...
                <ul class="price-table">
                  <li class="wow slideInUp">
                   ...
                   <span class="price-amount"><?php echo $one2; ?></span>
                      ...
                      <button data-text="BOOK NOW" class="button button-default" name="2ndbd" type="submit">
                  ...
                  <li class="wow slideInUp">
                    <div class="single-price">
                     ...
                     <span class="price-amount"><?php echo $one1; ?></span>
                      ...
                      <button data-text="BOOK NOW" class="button button-default" name="1stbd" type="submit">
                  ...
                  <li class="wow slideInUp">
                    <div class="single-price">
					  ...
					  <p><?php echo $eight3; ?></p><p>
                       <button data-text="BOOK NOW" class="button button-default" name="3rdbd" type="submit">
  ...
  <div class="footer-bottom" style="background:black">
      <p>Designed by <a rel="nofollow" href="indexlogin.php">LensArt Studio</a></p>
    </div>
