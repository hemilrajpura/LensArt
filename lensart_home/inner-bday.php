...
if(isset($_SESSION['uname']))
				{
						//header("location:http://localhost/edmin/code/2nd-innner-bday.php");
				}
...
<html lang="en">
        ...
        <div class="col-md-12">
          <div class="portfolio-area">
            <div class="title-area">
              <h2 class="tittle">bday Shoots</h2>
 ...
 <a class="fancybox"  data-fancybox-group="gallery" title="Photography">
	...
	{
	?>
	<img class="picture" height="400px" width='350px' style="float:left;" src="../../edmin/code/upload/<?php echo $row['bday']; ?> "/>
	<?php	
	}	
	}
		?>
	...
	?>
	<img class="picture" width='350px' height="400px"  style="float:left;"  src="../../edmin/code/upload/<?php echo $row['bday']; ?> "/>
	<?php	
	}	
	}
		?>
