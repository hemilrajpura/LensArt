...
if(isset($_SESSION['uname']))
				{
						//header("location:http://localhost/edmin/code/2nd-innner-wedding.php");
				}
...
<html lang="en">
 ...
 <a class="fancybox"  data-fancybox-group="gallery" title="Photography">
	...
	{
	?>
	<img class="picture" height="400px" width='350px' style="float:left;"
	...
	{
	?>
		<img class="picture" height="400px" width='350px' style="float:left;"  src="../../lensart/edmin/code/upload/<?php echo $row['wedding']; ?> "/>
	<?php	
	}	
	}
		?>
	...
	?>
	<img class="picture" width='350px' height="400px"  style="float:left;" 
	src="../../lensart/edmin/code/upload/<?php echo $row['wedding']; ?> "/>
	<?php	
	}	
	}
