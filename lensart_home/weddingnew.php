...
if(isset($_POST["2nd"]))
{
	...
	echo $_SESSION['PackageType']="second level";
...
if(isset($_POST["3rd"]))
{
	...
	$_SESSION['PackageType']="third level";
	header("location:http://localhost/lensart/lensart_signup/eventform.php");
}
if(isset($_POST["1st"]))
{
...
<html lang="en">
        ...
        <div class="col-md-12">
          <div class="portfolio-area">
            <div class="title-area">
              <h2 class="tittle">Wedding Shoots</h2>
  ...
  <!-- End Portfolio section -->
	<!-- End Portfolio section --> <a href="http://localhost/lensart/lensart_home/inner-wedding.php">
	<table> <tr> <td>
	<div class="album">
	...
	{
	?>
	<img width='180px' height='200' src="../../../lensart/edmin/code/upload/<?php echo $row['wedding']; ?> "/>
	<?php
	...
	{
	?>
	<img width='90px' height='100' src="../../../lensart/edmin/code/upload/<?php echo $row['wedding']; ?> "/>
	<?php
	...
	{
	?>
	<img rowspan=2 colspan=2 width='90px' height='100'
	src="../../../lensart/edmin/code/upload/<?php echo $row['wedding']; ?> "/>
	<?php
            ...
            <div class="pricing-table-content" style="margin-left:116px";>
                <ul class="price-table">
                  <li class="wow slideInUp">
                   ...
                   <span class="price-amount"><?php echo $one2; ?></span>
                      ...
                      <p><?php echo $seaven2; ?></p>
						 ...
						 <button data-text="BOOK NOW" class="button button-default" name="2nd" type="submit">
                    ...
                    <div class="single-price">
                     ...
                     <span class="price-amount"><?php echo $one1; ?></span>
                      ...
                      <p><?php echo $seaven1; ?></p>
                       <button data-text="BOOK NOW" class="button button-default" name="1st" type="submit">
                  ...
                  <li class="wow slideInUp">
                    ...
                    <button data-text="BOOK NOW" class="button button-default" name="3rd" type="submit">
