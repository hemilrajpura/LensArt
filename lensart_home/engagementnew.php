...
if(isset($_POST["2nden"]))
{
	...
	echo $_SESSION['PackageType']="Engagement - second level";
	header("location:http://localhost/lensart_signup/eventform.php"); 	echo $_SESSION['PackagePrice'];
...
<html lang="en">
  <head>
    ...
    <title>LensArt : Engagement</title>
    <!-- Favicon -->
  ...
  <div class="dropdown-content">
    ...
    <a href="indexlogin.php" >home page<i style="font-size:24px" class="fa">&#xf015;</i></a>
	 <a href="../Rex/userprofile.php">Profile<i style="font-size:24px" class="fa">&#xf007;</i></a>
        ...
        <div class="col-md-12">
          <div class="portfolio-area">
            <div class="title-area">
              <h2 class="tittle">Engagement Shoots</h2>
  ...
  <!-- End Portfolio section -->
	<!-- End Portfolio section -->
	<a href="http://localhost/lensart_home/inner-eng.php">
	<table> <tr> <td>
	<div class="album">
	...
	{
	?>
	<img width='180px' height='200' src="../../edmin/code/upload/<?php echo $row['engagement']; ?> "/>
	<?php
	...
	{
	?>
	<img width='90px' height='100' src="../../edmin/code/upload/<?php echo $row['engagement']; ?> "/>
	<?php
	...
	{
	?>
	<img rowspan=2 colspan=2 width='90px' height='100' src="../../edmin/code/upload/<?php echo $row['engagement']; ?> "/>
	<?php
                ...
                <ul class="price-table">
                  <li class="wow slideInUp">
                   ...
                   <span class="price-amount"><?php echo $one2; ?></span>
					  ...
					  <p><?php echo $eight2; ?></p><p><?php echo $nine2; ?></p>
						 <button data-text="BOOK NOW" class="button button-default" name="2nden" type="submit">
                    ...
                    <div class="single-price">
                     ...
                     <span class="price-amount"><?php echo $one1; ?></span>
                      ...
                      <p><?php echo $seaven1; ?></p><p><?php echo $eight1; ?></p><p><?php echo $nine1; ?></p>
                       <button data-text="BOOK NOW" class="button button-default" name="1sten" type="submit">
                  ...
                  <li class="wow slideInUp">
                    <div class="single-price">
					  ...
					  <p><?php echo $eight3; ?></p><p><?php echo $nine3; ?></p>
                    <button data-text="BOOK NOW" class="button button-default" name="3rden" type="submit">
