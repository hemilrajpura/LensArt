        ...
        <div class="main_features">
          <ul>
            ...
            <li> <i class="fa fa-user-plus" aria-hidden="true"></i>
              ...
              <h5><?php echo htmlentities($result->stock);?></h5>
              <p>Stock</p>
            </li>
...
<?php }} ?>
      ...
      <!--Side-Bar-->
       <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <p>Share: <a href="https://www.facebook.com/"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
		  <a href="https://twitter.com/login?lang=en"><i class="fa fa-twitter-square" aria-hidden="true"></i></a>
		  <a href="https://web.whatsapp.com/"><i class="fa fa-whatsapp" aria-hidden="true"></i></a> 
		  <a href="https://plus.google.com/up/?continue=https://plus.google.com/people"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a> </p>
        </div>
       <div class="sidebar_widget">
        ...
        $fname=$_POST['fname'];
				...
				$status=0;
				$vhid=$_GET['vhid'];
				$sql="INSERT INTO  tblbooking(name,userEmail,VehicleId,FromDate,ToDate,message,Status) VALUES(:fname,:useremail,:vhid,:fromdate,:todate,:message,:status)";
				$query = $dbh->prepare($sql);
        ...
        //$sql2="SELECT * from tblvehicles where id= :vhid";
      ...
      //  $query2->bindParam(':vid',$vid,PDO::PARAM_STR);
       // $results=$query2->fetchAll(PDO::FETCH_OBJ);
				...
				{
				  if ($result->stock>0) {
            //$vname= echo 'echo htmlentities($results->VehiclesTitle)';
            //$price= echo 'echo htmlentities($results->PricePerDay)';
						$abc = $result->stock;
						  $abc=$abc-1;
						  $_SESSION["stock"] = $abc;
									$sql="UPDATE tblvehicles SET stock=$abc WHERE id=$result->id;";
						  $query = $dbh -> prepare($sql);
						  $query->execute();
              require_once __DIR__ . '/vendor/autoload.php';
              $mpdf = new \Mpdf\Mpdf();
              $data = '<img src="assets/images/logo1.png">';
              $data .= '<centre><h1>BILL OF BOOKING A VEHICLE</centre>';
              $data .= '<table border="1">
              <tr>
                <th>Full Name</th>
                <td> '.$fname.'</td>
              ...
              <tr>
                <th>Bill to Pay(Price Per Day)</th>
                <td>'.$price.'</td>
              </tr>
              <tr>
                <th>PAYMENT MODE</th>
              ...
              $data .= '<p>Please pickup your car at our location by giving the PAYMENT</p><br />';
              $data .= '<p>HAVE A SAFE JOURNEY:)</p>';
              $mpdf->writeHTML($data);
              ...
              require './PHPMailerAutoload.php';
                  ...
                  $mail->SMTPAuth = true;                              
                  $mail->Username = 'modiy2433@gmail.com';                 
                  $mail->Password = '9374685055';                          
                  $mail->SMTPSecure = 'ssl';                           
                  $mail->Port = 465;                                   
                  //$mail->SMTPDebug = 3;
                  $mail->setFrom('modiy2433@gmail.com', 'carrental');
